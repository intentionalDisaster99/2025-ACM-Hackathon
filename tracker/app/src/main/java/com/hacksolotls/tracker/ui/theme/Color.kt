...
val surfaceContainerHighLightMediumContrast = Color(0xFFE2DBE3)
...
val tertiaryDark = Color(0xFFF2B7C2)
...
val primaryDarkMediumContrast = Color(0xFFE8D4FF)
