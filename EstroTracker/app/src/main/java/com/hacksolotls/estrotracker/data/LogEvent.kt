package com.hacksolotls.estrotracker.data
...
sealed interface LogEvent {
    /** Save the currently entered [com.hacksolotls.estrotracker.data.db.Log]. */
    ...
    /** Show the [com.hacksolotls.estrotracker.ui.composables.UpsertLogDialog]. */
    data object ShowDialog: LogEvent
    /** Hide the [com.hacksolotls.estrotracker.ui.composables.UpsertLogDialog]. */
